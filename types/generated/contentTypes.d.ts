...
export interface ApiDoencaDoenca extends Struct.CollectionTypeSchema {
...
export interface ApiTestemunhoTestemunho extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desc: Schema.Attribute.Text;
    doenca: Schema.Attribute.Relation<'manyToOne', 'api::doenca.doenca'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::testemunho.testemunho'
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    titulo_testemunho: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.DefaultTo<'t\u00EDtulo do testemunho'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::doenca.doenca': ApiDoencaDoenca;
